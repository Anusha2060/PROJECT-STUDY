    ...
    <div className="grid gap-36">
      <Banner>
        <div className="h-full w-full flex flex-col justify-center items-center gap-3 text-white">
          <div className="capitalize text-5xl font-bold playflair">
            Contact us
          </div>
      ...
      <div className="grid grid-cols-5 w-10/12 mx-auto">
        <div className="flex flex-col gap-20 col-span-2">
          <div className="flex flex-col gap-1">
            <div className="text-2xl font-bold text-orange-500 playflair">
              Contact
            </div>
            ...
            {contatdata.map((val, i) => {
              return (
                <div className="flex items-center gap-3 py-2 px-2">
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="text-lg font-medium text-gray-800 playflair">
                      {val.title}
                    </div>
        ...
        <div className="grid grid-cols-2 gap-4 col-span-3 mt-44">
          <input
            ...
            className="px-3 w-full h-10 rounded-sm border border-gray-600 outline-orange-500"
          />
          <input
            type="text"
          ...
          <input
            type="text"
            placeholder="Subject"
            className="px-3 col-span-2 w-full h-10 rounded-sm border  border-gray-600 outline-orange-500"
          />
          <textarea
            name=""
            placeholder="Your message"
            rows={8}
            className="px-3 resize-none col-span-2  w-full rounded-sm border  border-gray-600 outline-orange-500"
            id=""
          ></textarea>
          <button className="bg-orange-500 w-44 h-fit py-3 text-white rounded-full font-semibold cursor-pointer  hover:bg-orange-400 transition-all ease-in-out duration-500 delay-75">
            Send Message
          </button>
        </div>
      </div>
